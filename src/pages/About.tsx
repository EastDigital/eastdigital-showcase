            ...
            <div className="max-w-[1100px]">
              ...
              <nav className="mb-6">
                <div className="flex items-center space-x-2">
                  <a 
                    href="/" 
                    className="text-white text-lg leading-6 tracking-[0.54px] hover:text-white/80 transition-colors"
                    style={{ fontSize: '18px', lineHeight: '24px', letterSpacing: '0.54px' }}
                  >
                    Home
                  </a>
            ...
            <div className="max-w-[1100px] mx-auto">
              ...
              <div className="grid grid-cols-5 gap-6">
                {[
                  ...
                  <div key={index} className="bg-white rounded-lg p-4 h-20 flex items-center justify-center shadow-md">
                    <img 
                      src={logoUrl} 
                ...
                {[1, 2, 3, 4, 5].map((index) => (
                  <div key={index} className="bg-gray-800 rounded-lg overflow-hidden">
                    ...
                    <div className="p-4">
                      ...
                      >
                        50 Year tenure, Architectural, 
                        Engineering, Advisory Team
                      </p>
                    </div>
                  </div>
                ))}

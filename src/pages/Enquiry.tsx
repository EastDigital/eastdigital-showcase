                ...
                <div className="bg-card border border-border rounded-lg p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input id="company" name="company" type="text" required value={formData.company} onChange={handleChange} className="mt-1" />
                    </div>
                    <div>
                      <Label htmlFor="position">Position/Role</Label>
                      <Input id="position" name="position" type="text" value={formData.position} onChange={handleChange} className="mt-1" />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input id="projectName" name="projectName" type="text" required value={formData.projectName} onChange={handleChange} className="mt-1" />
                      </div>
                      <div>
                        <Label htmlFor="projectType">Project Type *</Label>
                        <select id="projectType" name="projectType" required value={formData.projectType} onChange={handleChange} className="mt-1 w-full bg-background border border-border rounded-md h-10 px-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <select id="serviceRequired" name="serviceRequired" required value={formData.serviceRequired} onChange={handleChange} className="mt-1 w-full bg-background border border-border rounded-md h-10 px-3">
                ...
                <div className="bg-card border border-border rounded-lg p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      ...
                      <Input id="deadline" name="deadline" type="date" value={formData.deadline} onChange={handleChange} className="mt-1" />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <select id="budget" name="budget" value={formData.budget} onChange={handleChange} className="mt-1 w-full bg-background border border-border rounded-md h-10 px-3">
                ...
                <div className="bg-card border border-border rounded-lg p-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <Textarea id="projectDescription" name="projectDescription" required rows={4} value={formData.projectDescription} onChange={handleChange} placeholder="Please provide a detailed description of your project, including goals, target audience, and key requirements..." className="mt-1" />
                    </div>
                    ...
                    <div>
                      ...
                      <Textarea id="referenceFiles" name="referenceFiles" rows={2} value={formData.referenceFiles} onChange={handleChange} placeholder="Please describe any reference materials you can provide (CAD files, architectural plans, sketches, inspiration images, etc.)" className="mt-1" />
                    </div>

 ...
 {/* Dynamic Project Gallery */}
        <ShortcodeRenderer content="[gallery-3d-still-renderings]" />
                ...
                <ul className="text-xl leading-relaxed tracking-wide text-muted-foreground mb-10">
                  <li className="text-on-black">• Photorealistic quality that showcases every detail</li>
                  <li className="text-on-black">• Fast turnaround times for urgent marketing needs</li>
                ...
                <div className="grid md:grid-cols-2 gap-6 mt-8">
                  <div className="space-y-3">
                    ...
                    <ul className="text-muted-foreground space-y-1">
                      <li className="text-on-black">• Brochures and flyers</li>

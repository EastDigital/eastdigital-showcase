      ...
      <div className="container mx-auto px-4 sm:px-6 sm: px-0 md:px-8 pb-8 sm:pb-12 lg:pb-32 relative z-[10]">
        <div className="w-full">
          ...
          <div className="flex flex-row sm:flex-row items-center justify-start gap-3 sm:gap-6">
            <a href="/enquiry" className="relative px-4 py-3 sm:px-8 sm:py-4 rounded-full text-cta text-sm sm:text-base bg-background/15 backdrop-blur border border-transparent font-semibold transition-all duration-300 cta-border text-center hover:text-cta-hover">
              <span className="relative z-10">Free Consultation</span>
            </a>
            <a href="/projects" className="relative px-4 py-3 sm:px-8 sm:py-4 rounded-full text-cta text-sm sm:text-base bg-background/60 backdrop-blur border border-transparent font-semibold transition-all duration-300 cta-border text-center hover:text-cta-hover">

        ...
        <div className="container mx-auto flex justify-between items-center h-full">
          ...
          <div className="hidden lg:block">
            <button className="relative px-6 py-3 rounded-full text-white bg-background/60 backdrop-blur border border-white/20 font-semibold transition-all duration-300 overflow-hidden group">
              <span 
                className="absolute inset-1 rounded-full border-1 border-transparent opacity-0 group-hover:opacity-100 group-hover:animate-borderGradient z-0 transition-opacity duration-300"
                style={{

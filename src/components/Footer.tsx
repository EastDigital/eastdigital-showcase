        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-8 relative z-10 flex flex-col items-start justify-between min-h-[40vh]">
          ...
          <div className="max-w-[850px]">
            ...
            <div className="space-y-6 sm:space-y-8 max-w-lg">
              ...
              <div>
                <p className="text-base sm:text-lg leading-relaxed tracking-wide text-accent mb-4">
                  If you need guidance on what information should be provided, simply fill out our request a proposal form below.
                </p>
                <a 
                  href="/enquiry" 
                  className="inline-flex items-center px-6 py-3 rounded-full bg-primary text-primary-foreground hover:bg-primary/90 transition-all duration-300 font-semibold text-lg"
                >
                  Take me to form 
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <a 
                  ...
                  className="text-lg sm:text-xl leading-relaxed tracking-wide text-white hover:text-accent transition-colors duration-300 font-bold px-6 py-4 rounded-xl bg-gradient-to-r from-accent/90 to-primary/90 hover:from-accent hover:to-primary border-2 border-accent/50 hover:border-accent shadow-lg hover:shadow-accent/30 transform hover:scale-105"
                >
                  📞 Call +91-99105 68689
                </a>
              </div>
